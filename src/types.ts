...
export interface MoltbotEnv {
  ...
  TELEGRAM_DM_ALLOW_FROM?: string; // Comma-separated list of allowed Telegram user IDs
  TELEGRAM_WEBHOOK_MODE?: string; // Set to 'true' to use webhook instead of polling
